...
var SeaSite = exports.SeaSite = function () {
    ...
    _createClass(SeaSite, [{
        ...
        key: 'readString',
        value: function readString(urlPath) {
            try {
                var content = this.read(urlPath).toString();
        ...
        key: 'writeAsHTML',
        value: function writeAsHTML(urlpath, $) {
        ...
        key: 'handleString',
        value: function handleString(content) {
            var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : LOAD_OPTIONS;
        ...
        key: 'readDOM',
        value: function readDOM(urlPath) {
            var content = this.readString(urlPath);
            if (content) {
            ...
            try {
                for (var _iterator3 = urlPaths[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
                    ...
                    if (/\.(html?|xml)$/i.test(urlPath)) {
                        ...
                        var $ = this.handleString(content, { xmlMode: xmlMode });
