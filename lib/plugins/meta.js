...
function meta() {
  ...
  return function ($) {
    ...
    opt = Object.assign({}, gopt, opt); // Canonical
    ...
    if (opt.lang) {
      $('html').attr('lang', opt.lang); // $('head').append(<link rel="alternate" hreflang="de" href="/help_de/index.html"/>)
    } // Alternate


    if (opt.alternate) {
      var _arr = Object.keys(opt.alternate);
