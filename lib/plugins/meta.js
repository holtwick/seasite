...
function meta() {
    ...
    return function ($) {
        ...
        if (opt.alternate) {
            ...
            try {
                for (var _iterator = Object.keys(opt.alternate)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                    var lang = _step.value;

                    $('head').append((0, _jsx.jsx)('link', { rel: 'alternate', hrefLang: lang, href: opt.alternate[lang] }));
                }
            } catch (err) {
        ...
        if (opt.description || opt.desc) {
            ...
            $('head').append((0, _jsx.jsx)('meta', { name: 'description', property: 'og:description', content: opt.description || opt.desc }));
        }
