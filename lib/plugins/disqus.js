...
function disqus() {
    ...
    return function ($) {
        ...
        (0, _assert2.default)(opt.selector, '"selector" required');
        (0, _assert2.default)(opt.path, '"path" required');
        (0, _assert2.default)((0, _site.isAbsoluteURL)(opt.url), '"url" needs to be absolute');
        ...
        $(opt.selector).each(function (i, el) {
            ...
            var html = (0, _jsx.jsx)(
                ...
                (0, _jsx.jsx)(
                    'div',
                    { id: 'disqus_thread', style: 'display: none;' },
                    (0, _jsx.jsx)(
                        'blockquote',
                        null,
                        (0, _jsx.jsx)(
                            'p',
                            null,
                            'The comment functionality is provided by ',
                            (0, _jsx.jsx)(
                                'a',
                        ...
                        (0, _jsx.jsx)(
                            ...
                            (0, _jsx.jsx)(
                                'button',
                                { onClick: 'showComments();return false;', className: 'btn btn-default' },
                                'Open Comments'
                            )
                        )
                    )
