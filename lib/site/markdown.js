...
function parseMarkdown(content) {
  ...
  result.props = props;
  opt.outline = opt.outline || props.outline; // https://github.com/chjj/marked
  ...
  renderer.heading = function (text, level) {
    ...
    if (anchor) {
      return "<h".concat(level, " data-anchor=\"").concat(anchor, "\"><a id=\"").concat(anchor, "\" name=\"").concat(anchor, "\" class=\"anchor\" href=\"#").concat(anchor, "\">").concat(text, "</a></h").concat(level, ">"); // return `<h${level} id="${anchor}"><a name="${anchor}" class="anchor" href="#${anchor}">${text}</a></h${level}>`
    }
