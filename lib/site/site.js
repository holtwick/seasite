...
var SeaSite = exports.SeaSite = function () {
    function SeaSite(srcPath) {
        ...
        _log3.default.setLevel(opt.logLevel || _log3.default.INFO);
        ...
        if (basePath == null) {
            ...
            // Copy site
            _log3.default.info('Site creation ... ' + srcPath + ' -> ' + basePath);
    ...
    _createClass(SeaSite, [{
        key: 'log',
        value: function log() {
            _log3.default.debug.apply(_log3.default, arguments);
        }
        ...
        value: function handle(pattern, handler) {
            ...
            if (!urlPaths || urlPaths.length <= 0) {
                _log3.default.warn('Did not match any file for', pattern);
            }
                    ...
                    if (ret !== false) {
                        ...
                        if (ret.ignore !== true) {
                            ...
                            if ((0, _dom.isDOM)(_content)) {
                                ...
                                _log3.default.error('Unknow content type for', p, '=>', _content);
                            }
                        }
                    }
                }
