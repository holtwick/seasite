...
function blog(site) {
  ...
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      ...
      var link = site.publicURL(post.htmlPath);
      var html = post.html;

      if (matomo) {
        link = (0, _plugins.matomoCampaignURL)(link, {
          name: 'rss',
          kw: post.htmlPath
        });
        html += (0, _plugins.matomoPixelImage)({
          matomo: matomo,
          name: 'rss',
          kw: post.htmlPath,
      ...
      var atomEntry = (0, _jsx.jsx)("item", null, (0, _jsx.jsx)("title", null, post.title), (0, _jsx.jsx)("link", null, link), (0, _jsx.jsx)("pubDate", null, (0, _dateformat["default"])(post.date, 'isoDateTime')), (0, _jsx.jsx)("author", null, opt.author), (0, _jsx.jsx)("description", null, html), (0, _jsx.jsx)("guid", null, post.htmlPath));
